...
import com.ruibing.home.dao.UserMapper;
 ...
 */
@Service
public class UserServiceImpl extends ServiceImpl<UserMapper, UserInnodb> implements UserService {
    @Override
    public void exceptionTest() {
        throw BusinessException.of("抛出异常测试");
    }
}
